<div class="box box-primary">
    ...
    ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="movil" id="movil" class="form-control" value="<?php echo $telefono?>" >
        </div>
        <div class="form-group">
            <label for="">Correo electronico:</label>
            <input type="text" name="email" id="email" class="form-control" value="<?php echo $correo?>" >
        </div>
